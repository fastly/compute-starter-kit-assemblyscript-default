import { Request,  Response, Fetchly } from "@fastly/as-compute";
...
function main(req: Request): Response {
    ...
    if (method == "GET" && path == "/backend") {
        ...
        let cacheOverride = new Fetchly.CacheOverride();
        cacheOverride.setTTL(60);
        return Fetchly.fetch(req, {
